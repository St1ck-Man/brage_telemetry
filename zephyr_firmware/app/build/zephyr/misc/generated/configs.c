...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOOPBACK_MODE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32C0_HSI_CLOCK_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32C0_TEMP_CAL_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_C092RC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_C092RC_STM32C092XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_STM32C0X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32C092XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_SAMPLE_POINT_MARGIN, 50);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_STATS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_MAX_STD_ID_FILTER, 28);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_MAX_EXT_ID_FILTER, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_STM32_FDCAN, 1);
